...
<div class="min-h-full">
      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            ...
            <!-- when clicking turns the background darkgrey -->
             <!-- responsible for the buttons on dashboard -->
              <!-- x-nav-link contains the css for the buttons -->
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      ...
      <div class="border-t border-white/10 pt-4 pb-3">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Derick Dev</div>
            <div class="text-sm font-medium text-gray-400">lihanda@gmail.com</div>
          </div>
  ...
  <header class="relative bg-gray-800 after:pointer-events-none after:absolute after:inset-x-0 after:inset-y-0 after:border-y after:border-white/10">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between ">
        <!-- $heading removed the hard coding of name dashboard -->
  ...
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <!-- responsible for content on the page below the heading -->
      {{$slot}}
    </div>
  </main>
</html>
